...
__all__ = [
    "accuracy", "load_state_dict", "make_directory", "save_checkpoint",
...
def load_state_dict(
    ...
    load_mode: str = None,
        ...
        nn.Module, nn.Module, str, int, float, torch.optim.Optimizer,
        ...
        *,
        ...
        if auto_augment_policy is not None:
            if auto_augment_policy == "ra":
                transforms.append(
                    T.RandAugment(interpolation=interpolation,
                ...
                transforms.append(
                    T.AugMix(interpolation=interpolation,
        ...
        transforms.extend([
            ...
            if use_v2 else T.ConvertImageDtype(torch.float),
